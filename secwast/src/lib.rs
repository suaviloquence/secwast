...
/// secwast::custom_reserved!(spaceship = "<=>");
///
...
///     lhs: secwast::core::Expression<'a>,
///     rhs: secwast::core::Expression<'a>,
/// }
///
...
/// # }
/// # mod annotation { secwast::annotation!(producer); }
///
