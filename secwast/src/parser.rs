...
//! ```
//! use secwast::Wat;
//! use secwast::parser::{self, ParseBuffer};
//!
//! # fn foo() -> Result<(), secwast::Error> {
//! let wat = "(module (func))";
...
//! ```
//! use secwast::kw;
//! use secwast::core::{Import, Func};
//! use secwast::parser::{Parser, Parse, Result};
//!
...
impl<'a> Parser<'a> {
    ...
    /// ```
    /// # use secwast::kw;
    /// # use secwast::token::NameAnnotation;
    /// # use secwast::parser::*;
    /// struct Module<'a> {
    ...
    ///
    /// ```
    /// # use secwast::{kw, annotation};
    /// # use secwast::core::Custom;
    /// # use secwast::parser::*;
    /// struct Module<'a> {
    ///     fields: Vec<ModuleField<'a>>,
    /// }
